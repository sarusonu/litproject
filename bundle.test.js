...
if (typeof require === 'function') {
  ...
  chai$2.use(sinonChai);
}

// es module plugins

// @ts-ignore
chai$2.use(chaiDomDiff);
// @ts-ignore
chai$2.use(chaiA11yAxe);
...
function html$1(strings, ...values) {
  ...
  // @ts-ignore
  return html(newStr, ...newVal);
}

const isIterable$1 = object => object != null && typeof object[Symbol.iterator] === 'function';
...
function isValidRenderArg(x) {
  return isIterable$1(x) ? [...x].every(isValidNonIterableRenderArg) : isValidNonIterableRenderArg(x);
}
...
const transform$1 = template => {
  if (isIterable$1(template)) {
    return [...template].map(v => transform$1(v));
  }
...
class ScopedElementsTestWrapper extends ScopedElementsMixin(LitElement) {
  ...
  render() {
    return transform$1(this.template);
  }
}
 ...
 * @returns {T}
 */
function litFixtureSync(template, options = {}) {
...
function _templateObject3() {
  var data = _taggedTemplateLiteral$1(["<my-element></my-element>"]);
...
function _templateObject2$1() {
  var data = _taggedTemplateLiteral$1(["<my-element name=\"Test\"></my-element>"]);
...
suite('my-element', () => {
  ...
  test('renders with default values', /*#__PURE__*/_asyncToGenerator(function* () {
    var el = yield fixture(html$1(_templateObject$1()));
    assert.shadowDom.equal(el, "\n      <h1>Hello, World!</h1>\n      <button part=\"button\">Click Count: 0</button>\n      <slot></slot>\n    ");
  }));
  test('renders with a set name', /*#__PURE__*/_asyncToGenerator(function* () {
    var el = yield fixture(html$1(_templateObject2$1()));
    assert.shadowDom.equal(el, "\n      <h1>Hello, Test!</h1>\n      <button part=\"button\">Click Count: 0</button>\n      <slot></slot>\n    ");
  }));
  test('handles a click', /*#__PURE__*/_asyncToGenerator(function* () {
    var el = yield fixture(html$1(_templateObject3()));
